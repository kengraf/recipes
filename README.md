# Recipes
This repo is my goto set of personal favorites.  In 2023 the number of recipes was getting too long, so they divided into a few categories.  Personnally I use the search function if I need to match the food on hand.  
...
The focus is on apps that are easy, meals that can simmer, and desserts you can make ahead.  So the focus is where it should be and not on the kitchen.  
